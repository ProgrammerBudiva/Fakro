...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img  alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" src="https://fakro.pro/image/catalog/лого-fakro-ua-шапка.png"/></a>
